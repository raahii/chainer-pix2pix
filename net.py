...
class Decoder(chainer.Chain):
    def __init__(self, out_ch):
        ...
        layers['c2'] = CBR(1024, 512, bn=True, sample='up', activation=F.relu, dropout=False)
        layers['c3'] = CBR(1024, 256, bn=True, sample='up', activation=F.relu, dropout=False)
        ...
        layers['c6'] = L.Convolution2D(128, out_ch, 3, 1, 1, initialW=w)
